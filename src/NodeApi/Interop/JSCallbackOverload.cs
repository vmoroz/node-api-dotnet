...
{
    public JSCallbackOverload(Type[] parameterTypes, JSCallbackFunc callback)
        : this(parameterTypes, null, callback)
    {
    }

    public JSCallbackOverload(Type[] parameterTypes, object?[]? defaultValues, JSCallbackFunc callback)
    {
