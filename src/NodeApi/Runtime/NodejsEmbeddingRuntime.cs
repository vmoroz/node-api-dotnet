...
public sealed class NodejsEmbeddingRuntime : IDisposable
{
    ...
    //public static explicit operator napi_env(NodejsEmbeddingRuntime runtime)
    //    => (napi_env)runtime._scope;
    ...
    internal NodejsEmbeddingRuntime(
        NodejsEmbeddingPlatform platform, string? baseDir, string? mainScript)
    {
        ...
        string baseDir)
    {
        ...
        string assemblyLocation =
            new Uri(typeof(NodejsEmbeddingRuntime).Assembly.CodeBase).LocalPath;
#else
        // Assembly.Location returns an empty string for assemblies embedded in a single-file app
#pragma warning disable IL3000 
        string assemblyLocation = typeof(NodejsEmbeddingRuntime).Assembly.Location;
